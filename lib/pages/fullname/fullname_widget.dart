...
import 'fullname_model.dart';
export 'fullname_model.dart';
...
class _FullnameWidgetState extends State<FullnameWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FullnameModel());
                                ...
                                child: FFButtonWidget(
                                  onPressed: () async {
                                    await currentUserReference!
                                      ...
                                      fullname: _model.textController.text,
                                    ));
